...
class GoogleFitRepositoryImpl implements GoogleFitRepository {
  ...
  @override
  Future<Either<Failure, int?>> getSteps(DateTime date) async {
    try {
      final hasPerms = await dataSource.hasPermissions();
      if (!hasPerms) {
        return const Left(PermissionDeniedFailure());
  ...
  @override
  Future<Either<Failure, double?>> getDistance(DateTime date) async {
    try {
      final hasPerms = await dataSource.hasPermissions();
      if (!hasPerms) {
        return const Left(PermissionDeniedFailure());
  ...
  @override
  Future<Either<Failure, double?>> getCalories(DateTime date) async {
    try {
      final hasPerms = await dataSource.hasPermissions();
      if (!hasPerms) {
        return const Left(PermissionDeniedFailure());
  ...
  @override
  Future<Either<Failure, double?>> getHeartRate(DateTime date) async {
    try {
      final hasPerms = await dataSource.hasPermissions();
      if (!hasPerms) {
        return const Left(PermissionDeniedFailure());
  ...
  @override
  Future<Either<Failure, double?>> getWeight() async {
    try {
      final hasPerms = await dataSource.hasPermissions();
      if (!hasPerms) {
        return const Left(PermissionDeniedFailure());
  ...
  @override
  Future<Either<Failure, double?>> getHeight() async {
    try {
      final hasPerms = await dataSource.hasPermissions();
      if (!hasPerms) {
        return const Left(PermissionDeniedFailure());
  ...
  @override
  Future<Either<Failure, void>> writeSteps(
    int steps,
    DateTime date,
  ) async {
    try {
